    ...
    class Program
    {
        ...
        static void DisplayAddMonster(List<Monster> monsters)
        {
            ...
            do
            {
                ...
                isValid = Enum.TryParse(Console.ReadLine(), out Monster.EmotionalState attitude);
                newMonster.Attitude = attitude;
                if (!isValid)
                {
                    Console.WriteLine();
                    Console.WriteLine("Please Enter a Valid Emotional State.");
                    Console.ReadKey();
                }
            } while (!isValid);
            ...
            do
            {
                Console.Write("\tTribe [Uru, Gortha, Yonvul, or Roko,]: ");
                isValid = Enum.TryParse(Console.ReadLine(), out Monster.Tribe tribe);
                newMonster.TribeAFL = tribe;
                if (!isValid)
                {
                    Console.WriteLine();
                    Console.WriteLine("Please Enter a Valid Tribe.");
                    Console.ReadKey();
                }
            } while (!isValid);
            ...
            do
            {                
                Console.Write("\tActive [True or False]:");
                switch (Console.ReadLine().ToLower().Trim())
                {
                    case "true":
                        newMonster.isActive = true;
                        Console.WriteLine($"{newMonster.Name} is Active.");
                        isValid = true;
                        break;
                    case "false":
                        newMonster.isActive = false;
                        Console.WriteLine($"{newMonster.Name} is Not Active.");
                        isValid = true;
                        break;
                    default:
        ...
        static void MonsterInfo(Monster monster)
        {
            ...
            Console.WriteLine($"\tTribe: {monster.TribeAFL}");
            Console.WriteLine("\t" + monster.TribeChant());
            Console.WriteLine($"\tActive: {monster.isActive}");
        }
